...
const Footer = ({ variant = 'detailed' }) => {
  ...
  if (variant === 'simple') {
    return (
      <footer className="bg-[#5A6C7D] text-white py-6">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-300">
              Kremna Company @ 2025. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
  ...
  return (
    <footer className="bg-[#5A6C7D] text-white py-12">
      <div className="container mx-auto px-4 max-w-7xl">
        {/* Logo Section */}
        <div className="mb-8">
          <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity inline-flex">
            <img 
              src={logoImg} 
              alt="Kremna Logo" 
              className="w-10 h-10 object-contain brightness-0 invert" 
            />
            <span className="font-bold text-xl">Kremna Company</span>
          </Link>
        </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.url}
                  className="hover:text-[#4ECDC4] transition-colors transform hover:scale-110 duration-200"
                  aria-label={link.name}
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <div className="border-t border-gray-600 pt-6">
          <p className="text-sm text-gray-300 text-center">
            © 2025 Kremna Company. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
